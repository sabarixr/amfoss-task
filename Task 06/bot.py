...
async def hello(ctx):
    await ctx.send("Hello there! I am a cricket score Discord bot named CricKey created as part of Amfoss task. I am glad to help you by providing data of cricket matches.")

@crickey.command(aliases=["more_info_message"])
async def moreinfo(ctx):
    await ctx.send ("you can get more info about cricket matches by visiting the link https://www.espncricinfo.com/live-cricket-score")
